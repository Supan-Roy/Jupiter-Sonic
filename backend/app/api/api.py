...
api_router.include_router(
    diarization.router, prefix="/diarization", tags=["Speaker Diarization"]
)
...
api_router.include_router(
    enhancement.router, prefix="/enhancement", tags=["Audio Enhancement"]
)
api_router.include_router(
    alignment.router, prefix="/alignment", tags=["Forced Alignment"]
)

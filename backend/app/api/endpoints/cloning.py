...
async def clone_voice(
    ...
    speaker_name: str = Form(..., description="Label or name for the cloned voice print"),
    ...
    try:
        result = await cloning_module.extract_voice_print(str(temp_path), speaker_name=speaker_name)
        return result
    finally:
        if temp_path.exists():
            temp_path.unlink()
